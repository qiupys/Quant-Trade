...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_date', default="20140101", help='start date of back test')
    parser.add_argument('--end_date', default='20240101', type=str, help='choose end date of back test')
